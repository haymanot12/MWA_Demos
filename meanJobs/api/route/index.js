...
router.route("/jobs/:jobId/company/:cId/address/:addressId").get(addressController.getOneAddress).put(addressController.updateAddress).delete(addressController.deleteAddress);
